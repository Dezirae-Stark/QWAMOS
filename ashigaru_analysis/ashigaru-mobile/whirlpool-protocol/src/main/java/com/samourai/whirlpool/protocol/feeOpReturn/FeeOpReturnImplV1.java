...
// MASKED(<FEE_PAYLOAD_V1>)(46) | MASKING_INPUT_PUBLIC_KEY(33) | OP_RETURN_VERSION(1)
// with FEE_PAYLOAD_MASKED_V1 =  feePayloadVersion:short(2) | samouraiFeeIndex:int(4) |
// scode:short(2) | feePartner:short(2) | <unused>(36)

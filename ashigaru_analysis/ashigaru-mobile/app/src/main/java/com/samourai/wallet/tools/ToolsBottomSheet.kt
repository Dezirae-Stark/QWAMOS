...
fun ToolsMainView(toolsBottomSheet: ToolsBottomSheet?, parentFragmentManager: FragmentManager?, window: Window?) {
    ...
    Scaffold {
        Column {
            ...
            ToolsItem(
                title = stringResource(id = R.string.options_paynym_calc),
                subTitle = stringResource(R.string.options_paynym_calc2),
                icon = R.drawable.ic_baseline_calculate,
                onClick = {
                    scope.launch {
                        val intent = Intent(context, PayNymCalcActivity::class.java)

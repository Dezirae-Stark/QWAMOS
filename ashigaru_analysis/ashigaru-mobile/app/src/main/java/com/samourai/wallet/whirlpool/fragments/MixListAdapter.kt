...
class MixListAdapter : RecyclerView.Adapter<MixListAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val viewBinding: ItemMixUtxoBinding) :
        ...
        fun bind(utxo: WhirlpoolUtxo) {
            ...
            viewBinding.mixAmount.text =  if(formatBalance == 1) FormatsUtil.formatSats(output.value)
            else if (formatBalance == 2) "*********"
            else FormatsUtil.formatBTC(output.value)
    ...
    fun setFormatBalance(format:Int){

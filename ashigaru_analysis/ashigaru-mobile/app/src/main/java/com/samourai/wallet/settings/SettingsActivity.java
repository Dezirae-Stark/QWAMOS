...
public class SettingsActivity extends SamouraiActivity {
    ...
    String activePreferences = ""; //PIN_ENTRY, VIEW_PUBKEYS
    ...
    public void onBackPressed() {
        if (this.activeFragment == ActiveFragment.SETTING) {
            if (activePreferences.equals("PIN_ENTRY")) {
                SettingsDetailsFragment fragment = new SettingsDetailsFragment("security");
                setFragment(fragment, true);
                activePreferences = "";
            }
            else if (activePreferences.equals("VIEW_PUBKEYS")) {
                SettingsDetailsFragment fragment = new SettingsDetailsFragment("wallet");
                setFragment(fragment, true);
                activePreferences = "";
            }
            else {

...
class WhirlpoolHome : SamouraiActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        whirlPoolHomeViewModel.switchBalanceFormat(balanceFormat, context = applicationContext)
    ...
    private fun initPager() {
        ...
        binding.toolbar.setOnClickListener {
            val newFormat = whirlPoolHomeViewModel.switchBalanceFormat(context = applicationContext)
            PrefsUtil.getInstance(this@WhirlpoolHome).setValue(PrefsUtil.BALANCE_FORMAT, newFormat)
        }
        ...
        whirlPoolHomeViewModel.formatBalanceLive.observe(this, {
    ...
    fun setBalance(position: Int) {
        ...
        val format = whirlPoolHomeViewModel.formatBalanceLive.value?: 0
        val balanceString =
            if (format == 1) FormatsUtil.formatSats(balance)
            else if (format == 2) "*********"
            else FormatsUtil.formatBTC(balance)

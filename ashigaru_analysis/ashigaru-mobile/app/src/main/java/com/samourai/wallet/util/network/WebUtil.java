...
//                    System.out.println("postURL:return code " + error);
    ...
    public String tor_getURL(
        ...
        final OkHttpClient.Builder builder = WebUtil.getInstance(context)
                .getTorHttpClientBuilder(url, timeout);
    ...
    public String tor_postURL(String URL, Map<String, String> args, Map<String,String> headers) throws HttpException {
        ...
        try {
            builder = WebUtil.getInstance(context).getTorHttpClientBuilder(URL);
        } catch (Exception e) {
            throw new HttpSystemException(e);
        }
    ...
    public String tor_postURL(String URL, String jsonToString, Map<String,String> headers) throws HttpException {
        ...
        OkHttpClient.Builder builder = getTorHttpClientBuilder(URL);
    ...
    public OkHttpClient.Builder getTorHttpClientBuilder(final String url) throws HttpException {
        return getTorHttpClientBuilder(url, DefaultRequestTimeout);
    }

    public OkHttpClient.Builder getTorHttpClientBuilder() {
        return getTorHttpClientBuilder(DefaultRequestTimeout);
    }

    public OkHttpClient.Builder getTorHttpClientBuilder(final long timeout) {
    ...
    public OkHttpClient.Builder getTorHttpClientBuilder(final String url, final long timeout)
            throws HttpException {

        final OkHttpClient.Builder builder = getTorHttpClientBuilder(timeout);

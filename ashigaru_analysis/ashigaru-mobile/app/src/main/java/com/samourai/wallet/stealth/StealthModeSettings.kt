...
fun StealthModeSettingsView(stealthModeSettings: StealthModeSettings) {
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                backgroundColor = samouraiBoxHeaderBackgroundGrey,
                title = {
        ...
        content = {
            Column(modifier = Modifier.fillMaxHeight().background(samouraiBoxHeaderBackgroundBlack)) {
                ListItem(
                    modifier = Modifier
                        .clickable {
                            scope.launch {
                                withContext(Dispatchers.Default) {
                                    isStealthEnabled =
                                        StealthModeController.toggleStealthState(context);
                                }
                            }
                        }
                        .padding(vertical = 8.dp),
